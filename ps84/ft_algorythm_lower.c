...
/*   Updated: 2023/06/28 19:12:28 by mamagalh@st      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_push_swap.h"

int	ft_highest(int **stacks, int stack, int *end)
{
	int	i;
	int	temp;
...
{
	if (stacks[stack][0] == ft_highest(stacks, stack, end))
		ft_rotate(stacks, stack, end, 0);
	else if (stacks[0][1] == ft_highest(stacks, 0, end))
